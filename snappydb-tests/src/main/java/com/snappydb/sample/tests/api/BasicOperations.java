...
import com.snappydb.sample.CustomDBImpl;
import com.snappydb.sample.MyCustomObject;
...
public class BasicOperations extends AndroidTestCase {
    ...
    @SmallTest
	public void testCreateCustomDB () throws SnappydbException  {
		...
		snappyDB = new CustomDBImpl(path);
