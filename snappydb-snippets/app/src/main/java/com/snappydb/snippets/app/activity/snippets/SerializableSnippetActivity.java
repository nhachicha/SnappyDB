...
import com.snappydb.snippets.app.model.serializables.Address;
import com.snappydb.snippets.app.model.serializables.Employee;
            ...
            mExecutor.submit(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        final Employee employee = mSnappyDB.get(key, Employee.class);
